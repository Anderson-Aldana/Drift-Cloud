...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('products-grid')) {
        displayStoreProducts(window.productsDatabase, 'products-grid');
        ...
        // Configurar filtros (tu código de filtros)
        // ...
    }
...
function applyFilters() {
    ...
    // Filtrar productos
    let filteredProducts = window.productsDatabase.filter(product => {
        const brandMatch = brandFilters.includes('all') || brandFilters.includes(product.brand);
        const typeMatch = typeFilters.includes('all') || typeFilters.includes(product.type);
        const flavorMatch = flavorFilters.includes('all') || flavorFilters.includes(product.flavor.toLowerCase());
        
        return brandMatch && typeMatch && flavorMatch;
    });
